...
public class SwaggerConfig {
    ...
    public ApiInfo apiInfo(){
        return new ApiInfoBuilder().title("ruby在线接口文档")
                .description("主要实现开发中的ruby项目的在线接口描述信息")
    ...
    public Docket createDocket(){
        return new Docket(DocumentationType.SWAGGER_2).//文档的类型
                ...
                apis(RequestHandlerSelectors.basePackage("com.qfedu.ruby.controller")).//需要生成接口文档的包 使用Swagger的包
                build();
    }
}
